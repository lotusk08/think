<script>
	...
	const focusStyle = `
		line, path, circle{stroke-width:3} 
		g[data-depth="0"] circle, g[data-depth="1"] circle{r:7} 
		g[data-depth="2"] circle{r:3} 
		circle {r:1} 
		g[data-depth="0"] line, g[data-depth="1"] line, path[data-depth="1"], circle{stroke-width:10} 
		g[data-depth="0"] circle {fill:var(--mindmap-primary-color)} 
		g[data-depth="2"] line, path[data-depth="2"], g[data-depth="1"] circle{stroke-width:6} 
		div{
		...
		g[data-depth="0"] div{
			border:2px solid var(--mindmap-primary-color);
			border-radius:5px; 
			padding-left:0.5em; 
			margin-left:-1.3em; 
			padding-top:0.35em
		...
		g[data-depth="1"] span {
			background-color:var(--mindmap-secondary-bg); 
			padding:0.3em 0.5em; 
			margin-top:-0.35em; 
			margin-left:-1em; 
			border-radius:5px;
		...
		g[data-depth="2"] div{margin-left:-1em;} 
		img{height:4em; display:block;}
	`
	const nolinesStyle = `
		line {stroke:transparent} 
		g[data-depth="0"] line{
			stroke:var(--mindmap-primary-color); 
			stroke-width:4
		} 
		g div{margin-top:10px;} 
		g[data-depth="0"] div{
			border:2px solid var(--mindmap-primary-color);
			margin-left:-1.4em; 
		...
		g[data-depth="0"] span {display:inline!important;} 
		circle{r:4} 
		g[data-depth="0"] circle{r:0} 
		circle:not([fill="rgb(255, 255, 255)"]){stroke:transparent} 
		path{stroke-width:2.5;} 
		path[data-depth="0"],path[data-depth="1"]{stroke-width:4;}
	`
	const blackStyle = `
		line, path, circle{stroke:var(--text-color)} 
		g[data-depth="0"] line{stroke-width:8} 
		g[data-depth="1"] line, path[data-depth="1"]{stroke-width:4} 
		g[data-depth="2"] line, path[data-depth="2"]{stroke-width:2} 
		circle{r:4} 
		g[data-depth="0"] circle{r:6} 
		circle:not([fill="rgb(255, 255, 255)"]){
			fill:var(--text-color); 
			stroke:transparent;
		}
	`
	...
	onMount(async () => {
		if ($url) {
			...
			if ($baseURL.includes('github') || $baseURL.includes('eyssette.forge')) {
				baseURL.update(n =>$baseURL + '/mymind');
			}
		}
